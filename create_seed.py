...
with open('admin_hash.txt', 'r') as f:
    hashed_password = f.read().strip()

seed_sql = f"""-- Seed Data for Vietnam Unique Travel
...
(1, 'admin', 'sales.vietnamuniquetravel@gmail.com', '{hashed_password}', 'Vietnam Unique Travel Admin', 'admin', 1)
...
print('seed.sql updated with INSERT IGNORE successfully!')
